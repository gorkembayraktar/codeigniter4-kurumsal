            ...
            <?php foreach($data as $item): ?>
                <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                        <div class="inner-block wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <figure class="image-box"><a href="<?=base_url("etkinliklerimiz/".$item['slug'])?>"><img style="width: 100%;height: 280px;object-fit: cover;" src="<?=base_url("public/images/events/".$item['image'])?>" alt="<?=$item['title']?>"></a></figure>
                            <div class="lower-content">
                                <div class="link-btn"><a href="<?=base_url("etkinliklerimiz/".$item['slug'])?>"><i class="flaticon-next"></i></a></div>
                                <h3><a href="<?=base_url("etkinliklerimiz/".$item['slug'])?>"><?=$item['title']?></a></h3>
